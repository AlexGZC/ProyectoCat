...
public class MapsActivity3 extends FragmentActivity implements OnMapReadyCallback,LoaderManager.LoaderCallbacks<Cursor>, View.OnClickListener {
    private static final String LOG_TAG = "ExampleApp";

    private static final String SERVICE_URL = "http://wssitiosudb.com/wssitios/Lugares/resultado/generar?filtro=tipo&tipo=3";
    protected GoogleMap map;
    MediaPlayer m;
    Marker ma;
    CoordinatorLayout coordinatorLayout;

    public MapsActivity3(){
        hand = new Handler();
    }
    Handler hand;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
            ...
            public void onMapLongClick(final LatLng point) {
                new AlertDialog.Builder(MapsActivity3.this)
    ...
    private void setUpMap() {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            Toast.makeText(MapsActivity3.this, "Servicios otorgados!", Toast.LENGTH_LONG).show();
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
                    == PackageManager.PERMISSION_GRANTED) {
                map.setMyLocationEnabled(true);
            }
